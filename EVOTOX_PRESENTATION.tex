...
\item Enhanced evaluation with detailed explanations
\item Intelligent feedback generation
...
\begin{lstlisting}[language=Python, caption=AI-Powered Evaluation]
...
\begin{itemize}
\item Detailed toxicity analysis with explanations
